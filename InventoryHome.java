...
class oop_inventory {
    public static void main(String[] args) {
        ...
        clickinventory_add.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                    ...
                    System.out.println(testing_value + 1);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            update_entry_panel.add(new JLabel(""));
            ...
            update_entry_panel.add(new JLabel("Enter total number of sheets."));
            update_entry_panel.add(new JTextField("", 1));
    ...
    clickexit.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            main_frame.dispose(); }});
    System.out.println(testing_value);    
